...
**Repository:** https://github.com/Moh.Akbari/akbari-dev-hub
...
2. **Site URL:** your canonical site (e.g. `https://akbari-dev-hub.vercel.app` or `https://yourdomain.com`).
3. **Redirect URLs:** add:
...
3. Click **Import** next to **akbari-dev-hub** (or paste `https://github.com/Moh.Akbari/akbari-dev-hub`).
...
| `NEXT_PUBLIC_SITE_URL` | Your Vercel or custom domain | e.g. `https://akbari-dev-hub.vercel.app` |
